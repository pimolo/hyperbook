...
class Book
{
     ...
     *     mimeTypesMessage = "Only valid PDFs are allowed."
     * )
     * @Vich\UploadableField(mapping="book", fileNameProperty="path")
     *
     * @var File
     */
    private $bookFile;
     ...
     *
     * @param File|\Symfony\Component\HttpFoundation\File\UploadedFile $book
     *
     * @return Book
     */
